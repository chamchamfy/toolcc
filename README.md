...
2. Tải tập tin 'sccf' vào '/sdcard'

       curl -s -L https://raw.githubusercontent.com/chamchamfy/toolcc/main/sccf -o /sdcard/sccf

4. Cài công cụ nhập dòng lệnh thực thi tập tin sccf:

       bash /sdcard/sccf
   
(Nhập c khi hiện xóa các tập tin trong '/sdcard/.ur/libcc'). 
